...
class sale_order_line_IBEE(models.Model):
    ...
    def _compute_amount(self):
        ...
        for line in self:
            ...
            price = (line.price_unit * (1 - (line.discount or 0.0) /
                     100.0)) + PuntoVerde_unit + IBEE_unit
    ...
    def _amount_by_group(self):
        for order in self:
            ...
            for line in order.order_line:
                ...
                price_reduce = (
                    line.price_unit * (1 - (line.discount or 0.0) / 100.0)) + PuntoVerde_unit + IBEE_unit
    ...
    def get_taxes_values(self):
        ...
        for line in self.invoice_line_ids:
            ...
            if not line.account_id or line.display_type:
                continue
            price_unit = (line.price_unit * (1 - (line.discount or 0.0) /
                          100.0)) + PuntoVerde_unit + IBEE_unit
