...
class SaleOrder(models.Model):
    ...
    def _find_mail_template(self, force_confirmation_template=False):
        ...
        if self.env.context.get("proforma", False):  # Proforma
            template_ref = "plantilles_email.proforma_email_template"
        elif self.state in ["draft", "sent"]:  # Pressupost
        ...
        if template_ref:
            template_id = self.env.ref(template_ref, raise_if_not_found=False)
